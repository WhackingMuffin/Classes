...
Tower* MachineGunTower::tower()
{
	...
	tower->sprite = Sprite::create("MachineTurret.png");
	// tower->sprite = Sprite::createWithSpriteFrameName("MachineGunTurret.png");
	// tower->setScale(0.5);
...
Tower* FastMachineGunTower::tower()
{
	...
	// tower->sprite = Sprite::createWithSpriteFrameName("FastMachineGunTurret.png");
	tower->setScale(0.5);
	tower->addChild(tower->sprite, 0);
	tower->range = 80;
	tower->schedule(schedule_selector(towerLogic), 0.2);
...
Tower* MissleGunTower::tower()
{
	...
	// tower->sprite = Sprite::createWithSpriteFrameName("MissleGunTurret.png");
	tower->setScale(0.5);
	tower->addChild(tower->sprite, 0);
	tower->range = 80;
	tower->schedule(schedule_selector(towerLogic), 0.2);
